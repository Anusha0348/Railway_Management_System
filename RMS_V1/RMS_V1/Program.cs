...
namespace RMS_V1
{
    internal class Program
    {
        ...
        static string[] train = new string[arraySize];
        static string[] stations = new string[stationSize];

        // Arrays for stations
        static string[] ts1 = new string[arraySize]; // for station 1
        static string[] ts2 = new string[arraySize]; // for station 2
        static string[] ts3 = new string[arraySize]; // for station 3
        static string[] ts4 = new string[arraySize]; // for station 4

        // Default routes
        static int routes = 0;

        // Arrays for trains arrival and departure times
        static int[,] tsArrivalHour = new int[4, arraySize]; // [station, train]
        static int[,] tsArrivalMinute = new int[4, arraySize]; // [station, train]
        static int[,] tsDepartureHour = new int[4, arraySize]; // [station, train]
        static int[,] tsDepartureMinute = new int[4, arraySize]; // [station, train]

        // Arrays for tickets and cargo
        const int ticketCapacity = 20;
        static int ticketCount = 0;
        static int cargoCount = 0;
        static int[] ticketPrices = new int[ticketCapacity];
        static int[] cargoPrices = new int[ticketCapacity];

        // Ticket arrays
        static string[] trainNames = new string[ticketCapacity];
        static string[] departureStations = new string[ticketCapacity];
        static string[] arrivalStations = new string[ticketCapacity];
        static int[] ticketQuantities = new int[ticketCapacity];
        static int[] ticketNumbers = new int[ticketCapacity];
        static int[] ticketPricesPaid = new int[ticketCapacity];
        static float[] ticketDays = new float[ticketCapacity];
        static float[] ticketMonths = new float[ticketCapacity];
        static float[] ticketYears = new float[ticketCapacity];
        static float[] ticketDates = new float[ticketCapacity];

        // Cargo arrays
        static string[] cargoTrains = new string[ticketCapacity];
        static string[] cargoDepartureStations = new string[ticketCapacity];
        static string[] cargoArrivalStations = new string[ticketCapacity];
        static int[] cargoWeights = new int[ticketCapacity];
        static int[] cargoPricesPaid = new int[ticketCapacity];
        static int[] cargoBookingNumbers = new int[ticketCapacity];
        static float[] cargoDays = new float[ticketCapacity];
        static float[] cargoMonths = new float[ticketCapacity];
        static float[] cargoYears = new float[ticketCapacity];
        static float[] cargoDates = new float[ticketCapacity];
